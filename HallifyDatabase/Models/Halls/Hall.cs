...
file sealed class HallConfigure: IEntityTypeConfiguration<Hall>
{
    public void Configure(EntityTypeBuilder<Hall> builder)
    {
        ...
        builder.HasData(
            new Hall { Id = InitialHalls.HallAId, Name = "Зал А", Capacity = 50, HourlyRate = 2000m, IsDeleted = false },
            new Hall { Id = InitialHalls.HallBId, Name = "Зал B", Capacity = 100, HourlyRate = 3500m, IsDeleted = false },
