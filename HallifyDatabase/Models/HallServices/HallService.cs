...
file sealed class HallServiceConfigure: IEntityTypeConfiguration<HallService>
{
    public void Configure(EntityTypeBuilder<HallService> builder)
    {
        ...
        builder.HasData(
            new HallService { Id = InitialHallServices.HallAProjector, HallId = InitialHalls.HallAId, Name = "Проєктор", Price = 500m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallAWifi,      HallId = InitialHalls.HallAId, Name = "Wi-Fi",     Price = 300m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallASound,     HallId = InitialHalls.HallAId, Name = "Звук",      Price = 700m, IsDeleted = false },

            new HallService { Id = InitialHallServices.HallBProjector, HallId = InitialHalls.HallBId, Name = "Проєктор", Price = 500m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallBWifi,      HallId = InitialHalls.HallBId, Name = "Wi-Fi",     Price = 300m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallBSound,     HallId = InitialHalls.HallBId, Name = "Звук",      Price = 700m, IsDeleted = false },

            new HallService { Id = InitialHallServices.HallCProjector, HallId = InitialHalls.HallCId, Name = "Проєктор", Price = 500m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallCWifi,      HallId = InitialHalls.HallCId, Name = "Wi-Fi",     Price = 300m, IsDeleted = false },
            new HallService { Id = InitialHallServices.HallCSound,     HallId = InitialHalls.HallCId, Name = "Звук",      Price = 700m, IsDeleted = false }
        );
    }
}
